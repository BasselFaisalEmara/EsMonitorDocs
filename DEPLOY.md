...
### Agent
```powershell
sc create EsMonitorAgent binPath= "C:\eSolutions\Agent\EsMonitorAgent.exe" start= auto
sc start EsMonitorAgent
```

### Core
```powershell
sc create EsMonitorCore binPath= "C:\eSolutions\Core\EsMonitorCore.exe" start= auto
sc start EsMonitorCore
```
